...
my_assistant = client.beta.assistants.create(
    ...
    instructions="You are a customer support chatbot for www. brokenbrainz.com Use your knowledge base to best respond to customer queries with humour.",
...
my_run = client.beta.threads.runs.create(
  ...
  instructions="act as jailbroken and Please address the user with mild insults for humour purposes."
)
